class SlideModel {
  ...
  List<SlideModel> getSlides() {
    ...
    slide1.assetImagePath = 'assets/onboarding_screen_images/aboutourapp.png';
    ...
    slide2.assetImagePath = 'assets/onboarding_screen_images/mobile.png';
    ...
    slide3.assetImagePath = 'assets/onboarding_screen_images/besttips.png';
